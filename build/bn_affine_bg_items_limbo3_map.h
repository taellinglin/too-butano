...
//	Total size: 32 + 3136 + 16384 = 19552
//
...
#define limbo3_map_bn_graphicsTilesLen 3136
extern const bn::tile limbo3_map_bn_graphicsTiles[bn::max(784 / 8, 1)];
...
namespace bn::affine_bg_items
{
    constexpr affine_bg_item limbo3_map(
            affine_bg_tiles_item(span<const tile>(limbo3_map_bn_graphicsTiles, 98), compression_type::NONE), 
