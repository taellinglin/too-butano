...
#define limbo3_bn_graphicsTilesLen 6784
extern const bn::tile limbo3_bn_graphicsTiles[bn::max(1696 / 8, 1)];
...
namespace bn::affine_bg_items
{
    constexpr affine_bg_item limbo3(
            affine_bg_tiles_item(span<const tile>(limbo3_bn_graphicsTiles, 212), compression_type::NONE), 
