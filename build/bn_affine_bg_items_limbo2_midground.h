...
//======================================================================
//
//	limbo2_midground_bn_graphics, 1024x1024@8, 
...
#define limbo2_midground_bn_graphicsTilesLen 6272
extern const bn::tile limbo2_midground_bn_graphicsTiles[bn::max(1568 / 8, 1)];

#define limbo2_midground_bn_graphicsMapLen 16384
extern const bn::affine_bg_map_cell limbo2_midground_bn_graphicsMap[16384];
...
namespace bn::affine_bg_items
{
    constexpr affine_bg_item limbo2_midground(
            affine_bg_tiles_item(span<const tile>(limbo2_midground_bn_graphicsTiles, 196), compression_type::NONE), 
            bg_palette_item(span<const color>(limbo2_midground_bn_graphicsPal, 16), bpp_mode::BPP_8, compression_type::NONE),
            affine_bg_map_item(limbo2_midground_bn_graphicsMap[0], size(128, 128), compression_type::NONE));
}
