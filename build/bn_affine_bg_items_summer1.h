...
//	+ 141 tiles (t reduced) not compressed
//	+ affine map, not compressed, 128x128 
//	Total size: 32 + 9024 + 16384 = 25440
//
...
#define summer1_bn_graphicsTilesLen 9024
extern const bn::tile summer1_bn_graphicsTiles[bn::max(2256 / 8, 1)];
...
{
    constexpr inline affine_bg_item summer1(
            affine_bg_tiles_item(span<const tile>(summer1_bn_graphicsTiles, 282), compression_type::NONE), 
