...
//	+ 149 tiles (t reduced) not compressed
//	+ affine map, not compressed, 128x128 
//	Total size: 32 + 9536 + 16384 = 25952
//
...
#define summer1_bn_graphicsTilesLen 9536
extern const bn::tile summer1_bn_graphicsTiles[bn::max(2384 / 8, 1)];
...
namespace bn::affine_bg_items
{
    constexpr affine_bg_item summer1(
            affine_bg_tiles_item(span<const tile>(summer1_bn_graphicsTiles, 298), compression_type::NONE), 
